 ...
 *         &lt;element name="idScheme" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="2" form="qualified"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CustomerIdentifierType {
    ...
    protected String id;
    @XmlElement(required = true)
    protected List<String> idScheme;
     ...
     * This is why there is not a <CODE>set</CODE> method for the idScheme property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getIdScheme().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<String> getIdScheme() {
        if (idScheme == null) {
            idScheme = new ArrayList<String>();
        }
